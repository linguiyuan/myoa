        ...
        <div class="mileage_table">
            <el-table
                ...
                <el-table-column
                    ...
                    width="90">
                    <template slot-scope="scope">
                        <span>{{scope.row.begintime | getIntTime2}}</span>
                    </template>
                </el-table-column>
                <el-table-column
                    label="结束时间"
                    width="90">
                    <template slot-scope="scope">
                        <span>{{scope.row.endtime | getIntTime2}}</span>
                    </template>
                </el-table-column>
                <el-table-column
                    prop="team"
                ...
                <el-table-column
                    ...
                    label="持续时间(秒)">
                    <template slot-scope="scope">
                        <span>{{scope.row.duration | secondToDate}}</span>
                    </template>
                </el-table-column>
                <el-table-column
                    width="100"
    ...
    export default {
        ...
        methods: {
            ...
            getMileagelist(ye = 0) {
                ...
                this.$ajax('/api/report/abnormaloperation',data)
                    .then((res) => {
                        this.loading = false;
                        if (res.errcode == 0) {
                    ...
                    .then((res) => {
                        ...
                        if (res.errcode == 0) {
                            ...
                            this.$nextTick(()=>{
                                ...
                                var wb = XLSX.utils.table_to_book(document.querySelector("#outTable1"), xlsxParam);
