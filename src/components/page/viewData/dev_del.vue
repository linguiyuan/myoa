<template>
    <div id="dev_del">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="140px" class="demo-ruleForm"
            ...
            <el-form-item>
                <el-button type="primary" @click="submitForm('ruleForm')">确认清除</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
        ...
        methods: {
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.$confirm('一旦清除，则该设备的所有数据全部清空，是否确认清除？', '提示', {
                            ...
                            this.$ajax('/api/receiver/clean',data)
                                .then(res=>{
                                    this.loading = false;
                                    if(res.errcode == 0){
                                        this.$message.success('设备清除成功')
                                    }else {
